                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <span class="mb-sm-20 d-block text-capitalize"><i class="fas fa-map-marker-alt text-primary font-12"></i> &nbsp;<?php echo $row['15'];?></span>
							</div>
                            <!-- <div class="col-md-6">
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
                                ...
                                <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage" style="width: 80px; height: 53.33px; object-fit: cover;">
                                    ...
                                    <span class="font-14"><i class="fas fa-map-marker-alt icon-primary icon-small"></i> <?php echo $row['15'];?></span>
