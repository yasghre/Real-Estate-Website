    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>User Messages</b></h2>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="full-row bg-gray">
            <div class="container">
                    <div class="row mb-5">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">User Queries</h2>
							<!-- <?php 
								if(isset($_GET['msg']))	
								echo $_GET['msg'];	
							?> -->
					...
					<table class="items-list col-lg-12" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-primary">
                                ...
                                <th class="text-white font-weight-bolder">Email Id</th>
                                <th class="text-white font-weight-bolder">Phone</th>
                                <th class="text-white font-weight-bolder">Query</th>
                        ...
                        <tbody>
							...
							<?php 
							// $id=$_SESSION['cid'];
							$query=mysqli_query($con,"SELECT * FROM contact order by cid DESC");
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="property-info d-table">
                                        <div class="text-secondary text-capitalize"><a href="contact.php?cid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></div>
                                ...
                                <!-- <td class="text-capitalize">For <?php echo $row['5'];?>
								...
								<!-- <td><a class="btn btn-primary" href="contactus.php?id=<?php echo $row['5'];?>">Delete</a></td> -->
                            </tr>
							<?php } ?>
